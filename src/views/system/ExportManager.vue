  ...
  <div>
    <el-card>
      <el-dialog :visible.sync="addWindow" width="56%"  close-on-click-modal close-on-press-escape	>
        <el-form inline  ref="form" :model="exoport" label-width="120px"  label-position="left">
          <el-row>
            <el-col :span="24">
          ...
          <el-form-item prop="urlPath" label="请求url" required>
            <el-input v-model="exoport.urlPath" style="width:470px"></el-input>
          </el-form-item>
          <el-form-item prop="requestType" label="请求类型" required>
            <el-tooltip placement="top">
              ...
              <el-select v-model="exoport.requestType">
          ...
          <el-form-item prop="sqlField" label="数据字段" v-if="exoport.istem==='N'" required>
            <el-select v-model="exoport.sqlField" multiple filterable allow-create default-first-option> </el-select>
          </el-form-item>
          <el-form-item prop="colNames" label="导出表头" v-if="exoport.istem==='N'" required>
            <el-select v-model="exoport.colNames" multiple filterable allow-create default-first-option></el-select>
          </el-form-item>
          <el-form-item>
      ...
      <common-table ref="table" :url="url" height="58vh" :columns="columns" fit autoLoad :formOptions="formOptions" >
 ...
 export default {
   ...
   methods: {
     ...
     handleEdit(index, row) {
       ...
       this.exoport.colNames = this.exoport.colNames.split(',')
       this.addWindow = true
     },
     hanleDel(row) {
       request({
